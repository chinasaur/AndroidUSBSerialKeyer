...
This can also be used as a backup key for rigs with a direct USB keying option, such as the QMX/QMX+ with firmware 1_03 or later.
...
The app connects to the USB serial hardware via [usb-serial-for-android](https://github.com/mik3y/usb-serial-for-android).
The AIOC and is designed to PTT when the DTR line is pulled; see [AIOC documentation](https://github.com/skuep/AIOC) for details.
